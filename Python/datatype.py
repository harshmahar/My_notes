...
# isupper: It returns True if the string is in upper case.
# islower: It returns True if the string is in lower case.
# isdigit: It returns True if the string contains numerical value..
# isdecimal: It returns True if the string contains decimal value i.e. 0 to 9.
# isalpha(): It returns True if the string contains alphabetic characters.
# isalnum(): It returns True if the string contains alphanumeric characters.
# isspace(): It returns True if all the characters in a string are whitespaces, otherwise False.
# istitle(): It returns True if all words in a text start with a upper case letter, AND the rest of the word are lower case letters, otherwise False. 
